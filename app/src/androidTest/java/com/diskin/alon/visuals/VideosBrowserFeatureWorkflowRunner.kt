...
@LargeTest
class VideosBrowserFeatureWorkflowRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                ...
                .withTags("@videos-browser-feature")
                .scenarios()
        }
    }
    ...
    fun test() {
        ...
        start(VideosBrowserFeatureWorkflowSteps())
    }
