...
/**
 * Step definitions runner for the 'Picture viewing fail' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class)
class PictureViewingFailStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                ...
                .withTags("@view-picture-sad-path")
                .scenarios()
    ...
    fun test() {
        ...
        start(PictureViewingFailSteps(featureTestApp.getMockedPicturesProvider()))
    }
}