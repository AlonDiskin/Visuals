...
import com.diskin.alon.visuals.photos.presentation.util.RecyclerViewMatcher.withRecyclerView
...
/**
 * [PicturesBrowserFragment] unit test class.
 */
@RunWith(AndroidJUnit4::class)
@LooperMode(LooperMode.Mode.PAUSED)
@SmallTest
class PicturesBrowserFragmentTest {

    // System under test
    private lateinit var scenario: FragmentScenario<PicturesBrowserFragment>

    // Mocked SUT collaborator
    private val viewModel: PicturesBrowserViewModel = mockk()
    ...
    fun setUp() {
        ...
        every { AndroidSupportInjection.inject(capture(fragmentSlot)) } answers {
            val picturesFragment = fragmentSlot.captured as PicturesBrowserFragment
    ...
    fun showPictureSelectionAndActionUi_whenUserStartPictureMultiSelection() {
        ...
        scenario.onFragment {
            val field = PicturesBrowserFragment::class.java.getDeclaredField("actionMode")
    ...
    fun openPictureDetail_whenPictureClicked() {
        ...
        intended(hasComponent(PictureViewerActivity::class.java.name))
