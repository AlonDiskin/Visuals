...
class PicturesViewModelImpl @Inject constructor(repository: PictureRepository) : ViewModel(), PicturesViewModel {

    private val _photos = MutableLiveData<List<Picture>>()
    override val photos: LiveData<List<Picture>>
        get() = _photos

    private val _photosUpdateError =
    ...
    init {
        // Subscribe to repository photos observable
